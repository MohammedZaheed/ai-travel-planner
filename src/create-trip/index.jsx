...
function CreateTrip() {
  ...
  return (
    <div className='sm:px-10 md:px-32 lg:px-56 xl:px-10 px-5 mt-10'>
      ...
      <p className='mt-3 text-gray-500 text-xl'>Share a few basic details, and our AI trip planner will craft a personalized itinerary just for you.</p>
      ...
      <div className='mt-20 flex flex-col gap-10'>
        ...
        <div>
          ...
          <Input placeholder={'Select number of days..'} type='number' onChange={(e) => handleInputChange('noOfDays', parseInt(e.target.value, 10))} />
        </div>
